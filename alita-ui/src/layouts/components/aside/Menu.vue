...
import { asideMenuIcons } from "@/layouts/config/helper";
import MainMenuConfig from "@/layouts/config/MenuConfig";
...
@/layouts/config/helper@/layouts/config/MainMenuConfig
