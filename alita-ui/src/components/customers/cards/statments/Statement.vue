<template>
  ...
  <div :class="`card ${cardClasses}`">
        ...
        >
          <li class="nav-item" role="presentation">
            <a
              ...
              data-bs-toggle="tab"
              role="tab"
              href="#customer_view_statement_1"
            >
              This Year
            </a>
          </li>
          ...
          <li class="nav-item" role="presentation">
            <a
              ...
              data-bs-toggle="tab"
              role="tab"
              href="#customer_view_statement_2"
            >
              2020
            </a>
          </li>
          ...
          <li class="nav-item" role="presentation">
            <a
              ...
              data-bs-toggle="tab"
              role="tab"
              href="#customer_view_statement_3"
            >
              2019
            </a>
          </li>
          ...
          <li class="nav-item" role="presentation">
            <a
              ...
              data-bs-toggle="tab"
              role="tab"
              href="#customer_view_statement_4"
            >
              2018
            </a>
          </li>
    ...
    <div class="card-body pb-5">
      <!--begin::Tab Content-->
      <div id="customer_view_statement_tab_content" class="tab-content">
        <div
          id="customer_view_statement_1"
