...
class LayoutService {
  ...
  public static initToolbar(): void {
    this.bodyStore.addBodyAttribute({
      qualifiedName: "data-app-toolbar-enabled",
      value: "true",
    });
    ...
    if (objectPath.get(config.value, "toolbar.fixed.desktop")) {
      this.bodyStore.addBodyAttribute({
        qualifiedName: "data-app-toolbar-fixed",
        value: "true",
      });
    }
    ...
    if (objectPath.get(config.value, "toolbar.fixed.mobile")) {
      this.bodyStore.addBodyAttribute({
        qualifiedName: "data-app-toolbar-fixed-mobile",
        value: "true",
      });
    }
  }
  ...
  public static initSidebar(): void {
    ...
    this.bodyStore.addBodyAttribute({
      qualifiedName: "data-app-sidebar-enabled",
      value: "true",
    });

    this.bodyStore.addBodyAttribute({
      qualifiedName: "data-app-sidebar-fixed",
      value: "true",
    });
    ...
    if (
      ...
      this.bodyStore.addBodyAttribute({
        qualifiedName: "data-app-sidebar-minimize",
        value: "on",
      });
    }
    ...
    if (
      ...
      this.bodyStore.addBodyAttribute({
        qualifiedName: "data-app-sidebar-hoverable",
        value: "true",
      });
    }

    this.bodyStore.addBodyAttribute({
      qualifiedName: "data-app-sidebar-push-header",
      value: "true",
    });

    this.bodyStore.addBodyAttribute({
      qualifiedName: "data-app-sidebar-push-toolbar",
      value: "true",
    });

    this.bodyStore.addBodyAttribute({
      qualifiedName: "data-app-sidebar-push-footer",
      value: "true",
    });
    ...
    if (
      ...
      if (
        ...
        this.bodyStore.addBodyAttribute({
          qualifiedName: "data-app-sidebar-primary-minimize",
          value: "on",
        });
      }
      ...
      if (
        ...
        this.bodyStore.addBodyAttribute({
          qualifiedName: "data-app-sidebar-primary-hoverable",
          value: "on",
        });
      }
      ...
      if (
        ...
        if (
          ...
          this.bodyStore.addBodyAttribute({
            qualifiedName: "data-app-sidebar-primary-minimize-mobile",
            value: "on",
          });
        }
        ...
        if (
          ...
          this.bodyStore.addBodyAttribute({
            qualifiedName: "data-app-sidebar-primary-hoverable-mobile",
            value: "on",
          });
        }
      }
      ...
      if (
        ...
        if (
          ...
          this.bodyStore.addBodyAttribute({
            qualifiedName: "data-app-sidebar-primary-collapse",
            value: "on",
          });
        }
      }
      ...
      if (
        ...
        if (
          ...
          this.bodyStore.addBodyAttribute({
            qualifiedName: "data-app-sidebar-primary-collapse-mobile",
            value: "on",
          });
        }
      }
  ...
  public static initSidebarPanel(): void {
    ...
    if (objectPath.get(config.value, "sidebarPanel.fixed.desktop")) {
      this.bodyStore.addBodyAttribute({
        qualifiedName: "data-app-sidebar-panel-fixed",
        value: "true",
      });
    } else {
      this.bodyStore.addBodyAttribute({
    ...
    if (objectPath.get(config.value, "sidebarPanel.minimize.desktop.enabled")) {
      if (
        ...
        this.bodyStore.addBodyAttribute({
          qualifiedName: "data-app-sidebar-panel-minimize",
          value: "on",
        });
      }
      ...
      if (
        ...
        this.bodyStore.addBodyAttribute({
          qualifiedName: "data-app-sidebar-panel-hoverable",
          value: "on",
        });
      }
  ...
  public static initHeader(): void {
    ...
    if (objectPath.get(config.value, "header.default.fixed.desktop")) {
      this.bodyStore.addBodyAttribute({
        qualifiedName: "data-app-header-fixed",
        value: "true",
      });

      this.bodyStore.addBodyAttribute({
        qualifiedName: "data-app-header-minimize",
        value: "on",
      });
    }
    ...
    if (objectPath.get(config.value, "header.default.fixed.mobile")) {
      this.bodyStore.addBodyAttribute({
        qualifiedName: "data-app-header-fixed-mobile",
        value: "true",
      });
    }
  }
  ...
  public static initFooter(): void {
    if (objectPath.get(config.value, "footer.fixed.desktop")) {
      this.bodyStore.addBodyAttribute({
        qualifiedName: "data-app-footer-fixed",
        value: "true",
      });
    }
    ...
    if (objectPath.get(config.value, "footer.fixed.mobile")) {
      this.bodyStore.addBodyAttribute({
        qualifiedName: "data-app-footer-fixed-mobile",
        value: "true",
      });
    }
  }
